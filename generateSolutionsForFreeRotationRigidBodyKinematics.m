...
%|
%|          [ 6.1 ] To determine the time rate of change of the "scalar
%|                  first unit quaternion",
%|                  here the LAST PART of Equation (46) on Page 266
%|                  of Reference [ 1 ] is used.
%|
%|-----------------------------------------------------------------------------
%|
%|  REFERENCE(s):
...
%
%          [ 1.1 ] To determine the time rate of change of the "scalar
%                  first unit quaternion",
%                  here the LAST PART of Equation (46) on Page 266
%                  of Reference [ 1 ] is used.
%
...
%-------------------------------------------------------------------------------
%  Fetch scalar and vector part of the specified quaternion.
%-------------------------------------------------------------------------------
   quaternionScalarPart     =   currentScalarFirstUnitQuaternion             ...
                                             ( STATE_QUATERNION_S_INDEX );
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   rotationHalfAngleRadians = acos( quaternionScalarPart     );
   sineHalfAngle            = sin(  rotationHalfAngleRadians );
   cosineHalfAngle          =       quaternionScalarPart;
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   quaternionVectorPart     =                                                ...
             [                                                               ...
               currentScalarFirstUnitQuaternion( STATE_QUATERNION_X_INDEX ); ...
               currentScalarFirstUnitQuaternion( STATE_QUATERNION_Y_INDEX ); ...
               currentScalarFirstUnitQuaternion( STATE_QUATERNION_Z_INDEX )  ...
             ] / sineHalfAngle;
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   vectorLength             = norm( quaternionVectorPart     );
%-------------------------------------------------------------------------------
%
...
%-------------------------------------------------------------------------------
   [                                                                         ...
     quaternionCrossAngularVelocity                                          ...
   ] = vectorProduct                                                         ...
             (                                                               ...
               quaternionVectorPart,                                         ...
               currentAngularVelocityVectorBodyCoords                        ...
...
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   [                                                                         ...
     quaternionDotAngularVelocity                                            ...
   ] = dot(                                                                  ...
            quaternionVectorPart,                                            ...
            currentAngularVelocityVectorBodyCoords                           ...
          );
%-------------------------------------------------------------------------------
   quaternionDerivativeScalar = -0.5                            *            ...
                                sineHalfAngle                   *            ...
                                ( 1.0 / vectorLength )          *            ...
                                quaternionDotAngularVelocity;
%-------------------------------------------------------------------------------
   quaternionDerivativeVector =  0.5 *                                       ...
                                (                                            ...
                                  (                                          ...
                                    sineHalfAngle                            ...
                                    *                                        ...
...
%-------------------------------------------------------------------------------
   currentStateDerivatives                                                   ...
          ( STATE_DERIV_QUATERNAION_S_INDEX ) = quaternionDerivativeScalar;
%- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
   currentStateDerivatives                                                   ...
          ( STATE_DERIV_QUATERNAION_X_INDEX ) = quaternionDerivativeVector   ...
                                                               ( X_INDEX );
   currentStateDerivatives                                                   ...
          ( STATE_DERIV_QUATERNAION_Y_INDEX ) = quaternionDerivativeVector   ...
                                                               ( Y_INDEX );
   currentStateDerivatives                                                   ...
          ( STATE_DERIV_QUATERNAION_Z_INDEX ) = quaternionDerivativeVector   ...
                                                               ( Z_INDEX );
%-------------------------------------------------------------------------------
%
